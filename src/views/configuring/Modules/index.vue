  ...
  methods: {
    ...
    async checkChange(obj, checked, childrenChecked, type) {
      ...
      let res = await $axios.post(
        "https://tonglingok.com/canteen/api/v1/module/default/handel",
        form
      );
      if (res.msg === "ok") {
        if (!obj.items) {
    ...
    async submitModulesForm() {
      ...
      const url =
        "https://tonglingok.com/canteen/api/v1/module/system/canteen/save";
    ...
    async submitEditModulesForm() {
      let res = await $axios.post(
        "https://tonglingok.com/canteen/api/v1/module/update",
        this.editModuleForm
      );
      if (res.msg === "ok") {
    ...
    async renderModules() {
      try {
        const res = await $axios.get(
          "https://tonglingok.com/canteen/api/v1/modules?type=2"
        );
        if (res.msg === "ok") {
    ...
    async changeModulesState(row) {
      ...
      const res = await $axios.post(
        "https://tonglingok.com/canteen/api/v1/module/system/handel",
        data
      );
      if (res.msg === "ok") {
