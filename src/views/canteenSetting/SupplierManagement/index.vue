  ...
  methods: {
    ...
    async fetchSupplierList() {
      if (this.companiesVisible) {
        await $axios
          .get(
            `https://tonglingok.com/canteen/api/v1/suppliers?c_id=${
              this.company_id
        ...
        await $axios
          .get(
            `https://tonglingok.com/canteen/api/v1/suppliers?page=${
              this.page
            }&size=10`
          )
          .then(res => {
    ...
    handleDelete(val) {
      ...
      this.$confirm("确定删除该供应商吗？", "提示", {
        ...
        .then(() => {
          $axios
            .post("https://tonglingok.com/canteen/api/v1/supplier/delete", {
    ...
    confirmReset() {
      ...
      $axios
        .post(
          "https://tonglingok.com/canteen/api/v1/supplier/update",
