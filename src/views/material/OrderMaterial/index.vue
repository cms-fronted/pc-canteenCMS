...
export default {
  ...
  methods: {
    ...
    async exportFile() {
      this.$exportExcel(
        "https://tonglingok.com/canteen/api/v1/material/exportOrderMaterials",
        this.queryForm
      );
      /*   const res = await $axios.get(
        "https://tonglingok.com/canteen/api/v1/material/exportOrderMaterials",
    ...
    async queryList(page) {
      page = page || 1;
      const res = await $axios.get(
        `https://tonglingok.com/canteen/api/v1/order/materialsStatistic?page=${page}&size=${
          this.size
        }`,
        this.queryForm
      );
    ...
    async submitOrder() {
      ...
      const res = await $axios.post(
        "https://tonglingok.com/canteen/api/v1/order/material/update",
        this.updateForm
      );
      if (res.msg === "ok") {
        this.queryForm = {};
